...
#rm mismatch from META--one unknow
...
length (unique (GPL570.disDS.KMvsGEO))#20/38 datasets --21/39---22/40
length(GPL570.disSP.KMvsGEO)  #V1:72 samples/2635 --V2:75/2645--V3:79 sp/2688
...
length (unique (GPL570.disDS.KMvsGEO.Sure)) #17/39---18/40
length(GPL570.disSP.KMvsGEO.Sure) #53/2621--57/2664
