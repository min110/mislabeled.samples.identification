...
}function c(o,m,j){var k=o+" "+m,l=k.length,q=j;
if(l>q){var p=(l-q)+4,n=o.substring(0,o.length-p)+"....";
k=n+" "+m
}return k
}var g={title:document.title.replace(/\-/g,""),url:b(),};
window.addthis_share={title:g.title,url:g.url,passthrough:{twitter:{text:c(g.title,g.url,140)}}};
